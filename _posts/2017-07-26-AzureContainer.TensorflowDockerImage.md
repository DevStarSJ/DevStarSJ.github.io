...
- 우측 상단 `+ New` 클릭
  - `Storage >` 선택
    ...
    - ![](https://raw.githubusercontent.com/DevStarSJ/Study/master/Blog/Cloud/Azure/images/azure.file.01.png)
      ...
      - ![](https://raw.githubusercontent.com/DevStarSJ/Study/master/Blog/Cloud/Azure/images/azure.file.02.png)
      - `Pin to dashboard`를 선택하면 대쉬보드에 아이콘이 생성되어서 쉽게 진입이 가능하다.
      - `Create`를 눌러서 생성 한 후 다 생성되기를 기다린다.

생성이 끝나면 대쉬보드 화면에 아이콘이 하나 추가된다.

![](https://raw.githubusercontent.com/DevStarSJ/Study/master/Blog/Cloud/Azure/images/azure.file.03.png)

해당 아이콘을 눌러서 들어간다.

`Overview` -> `Files`을 눌러서 들어간 후 File Storage를 하나 생성한다.

![](https://raw.githubusercontent.com/DevStarSJ/Study/master/Blog/Cloud/Azure/images/azure.file.04.png)
...
![](https://raw.githubusercontent.com/DevStarSJ/Study/master/Blog/Cloud/Azure/images/azure.file.05.png)
...
![](https://raw.githubusercontent.com/DevStarSJ/Study/master/Blog/Cloud/Azure/images/azure.file.06.png)
...
- 우측 상단 `+ New` 클릭
  - `Containers >` 선택
    ...
    - ![](https://raw.githubusercontent.com/DevStarSJ/Study/master/Blog/Cloud/Azure/images/azure.cs.01.png)
      - 1. Basics
        ...
        - ![](https://raw.githubusercontent.com/DevStarSJ/Study/master/Blog/Cloud/Azure/images/azure.cs.02.png)
      - 2. Master configuration
        ...
        - ![](https://raw.githubusercontent.com/DevStarSJ/Study/master/Blog/Cloud/Azure/images/azure.cs.03.png)
      - 3. Agent configuration
        - 실행할 환경을 설정한다. 일단 테스트라 가장 싼것으로 찾아보려 했으나... ;;;
        - ![](https://raw.githubusercontent.com/DevStarSJ/Study/master/Blog/Cloud/Azure/images/azure.cs.04.png)
  ...
  - `Containers >` 선택
    - `Azure Container Register` 선택
      - `Registry name Name`: (ex. acrtensorflow)
        ...
        - ![](https://raw.githubusercontent.com/DevStarSJ/Study/master/Blog/Cloud/Azure/images/azure.cr.01.png)

거의 바로 만들어 진다.

해당 메뉴로 들어가서 `Access keys`를 누른후  `Admin user`를 `Enable`로 선택하면 접속에 필요한 **Username**과 **password** 확인이 가능하다.

![](https://raw.githubusercontent.com/DevStarSJ/Study/master/Blog/Cloud/Azure/images/azure.cr.02.png)
