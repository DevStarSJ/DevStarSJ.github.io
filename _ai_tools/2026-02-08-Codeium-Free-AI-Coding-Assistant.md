...
![Code editor with AI suggestions](https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=800)
...
3. Click Install
4. Create free account at codeium.com
5. Authenticate in VS Code

### First Steps

After installation, Codeium works automatically:

1. **Start typing** - Suggestions appear in gray
2. **Tab to accept** - Full suggestion
3. **Ctrl+Right** - Accept word by word
4. **Alt+]** - Cycle through alternatives
...
✅ Developers curious about AI coding tools
✅ Teams evaluating AI assistants
✅ Anyone writing code regularly
