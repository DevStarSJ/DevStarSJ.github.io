...
excerpt: "Claude Projects lets you create persistent AI workspaces with custom knowledge, instructions, and context. Learn how to build your personal AI assistant that truly knows your work."
---
...
![Claude Projects — Persistent AI Workspace](https://images.unsplash.com/photo-1642427749670-f20e2e76ed8c?w=1200&auto=format&fit=crop)
...
Define Claude's role, behavior, and constraints for this project:
```
...
**2. Knowledge (Uploaded Files)**
Upload documents Claude will always reference:
...
All conversations within a project share context — Claude remembers what you discussed last week in the same project.
...
**Week 1:** Basic role and constraints
**Week 2:** Add specific formatting preferences
**Week 3:** Add edge case handling
**Week 4:** Add examples of ideal outputs
...
- **Organize with clear filenames** — `2026-product-roadmap.pdf` not `doc1.pdf`
...
**Get started:** [claude.ai](https://claude.ai) (Pro plan required)
