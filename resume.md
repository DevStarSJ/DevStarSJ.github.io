...
**Tech Product Team Lead** (2024.01 ~ 2025.05) — Python, FastAPI, Prisma, Celery
...
- **2025년 중반 팀 재통합 건의**: 두 팀으로 나눈 구조가 실보다 득이 적다고 판단하여 재통합을 건의했고, 통합된 Financial AI 팀의 Lead 자리는 제품 담당자에게 넘겼습니다. SRE와 Tech Lead 역할을 병행하는 상황에서 세일즈·제품 영역까지 함께 책임지는 것이 적절하지 않다고 판단했습니다.
