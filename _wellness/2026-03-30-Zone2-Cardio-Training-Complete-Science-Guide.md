...
![Person running on a trail through a forest](https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?w=900&auto=format&fit=crop)
...
| **Zone 2** | **60–70%** | **Comfortable, can hold conversation** | **Fat (dominant)** |
| Zone 3 | 70–80% | Moderate, slightly breathless | Mixed |
| Zone 4 | 80–90% | Hard, only short sentences | Carbs (dominant) |
| Zone 5 | 90–100% | Maximum, cannot speak | Carbs |
...
**Formula:** 220 – age = estimated max HR
...
2. **Mitochondrial efficiency** — improving how well existing mitochondria function
3. **Mitochondrial density** — packing more power capacity into each cell
...
![Cyclist on a scenic road](https://images.unsplash.com/photo-1544191696-15693bdf5309?w=900&auto=format&fit=crop)
*Photo by Coen van den Broek on Unsplash*

---

## Zone 2 vs. High-Intensity Training (HIIT)
...
1. **Cycling (bike or stationary)** — easy to control intensity, low impact
2. **Rowing machine** — full body, excellent for Zone 2
3. **Swimming** — joint-friendly, harder to monitor HR
4. **Running/jogging** — accessible but higher injury risk
5. **Brisk walking (uphill)** — for beginners or very fit people (flat may be Zone 1)
6. **Elliptical** — good option, lower impact than running
7. **Cross-country skiing** — elite Zone 2 option, full body
