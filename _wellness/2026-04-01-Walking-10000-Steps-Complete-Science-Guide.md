...
category: exercise
tags: [walking, steps, cardio, longevity, mental-health, exercise, weight-loss]
---
...
![Person walking on a trail at sunrise](https://images.unsplash.com/photo-1551632436-cbf8dd35adfa?w=900&q=80)
...
1. **Suppresses hunger hormones** — moderate exercise suppresses ghrelin (hunger) and amplifies peptide YY and GLP-1 (fullness signals)
2. **Improves sleep quality** — better sleep dramatically reduces hunger and cravings
3. **Reduces stress eating** — lower cortisol means fewer stress-driven caloric choices
4. **Preserves muscle** — unlike aggressive dieting, walking helps maintain lean mass while losing fat
...
| Speed | Intensity | MET | Best For |
|---|---|---|---|
| Strolling (<2.5 mph) | Very light | 2.0 | Active recovery, phone calls |
| Moderate (2.5–3.0 mph) | Light | 3.0 | General health, beginners |
| **Brisk (3.0–3.5 mph)** | **Moderate** | **3.5–4.0** | **Cardiovascular benefit** |
| Power walking (3.5–4.5 mph) | Vigorous | 4.5–5.0 | Fitness, weight loss |
